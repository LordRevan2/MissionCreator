...
namespace MissionCreator.StaticData
{
    public static class PedData
    {
        public static Dictionary<string, Tuple<string, uint>[]> Database = new Dictionary<string, Tuple<string, uint>[]>
        {
            ...
            new Tuple<string, uint>("Marine 1", 1702441027),
            new Tuple<string, uint>("Marine 2", 1490458366),
            new Tuple<string, uint>("Marine 3", 1925237458),
            new Tuple<string, uint>("Pilot", 2872052743),
